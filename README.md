...
```shell
docker pull quay.io/purestorage/pure-exporter:1.2.3
```

or

```shell
docker pull quay.io/purestorage/pure-fa-exporter:1.2.3
```
or

```shell
docker pull quay.io/purestorage/pure-fb-exporter:1.2.3
```
---
